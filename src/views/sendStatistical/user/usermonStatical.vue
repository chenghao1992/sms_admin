<template>
	<div class="user_mon">
		...
		<el-row>
            <el-col :span="25">
                <div class="echart" id="chartLine_user2" style="width:100%;  height:400px; margin-top:10px"></div>
...
<script>
  ...
  export default {
    ...
    methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                  if (valid) {
                    ...
                    this.mark_total = 0;
                    this.notice_total = 0;
                    let params = {statisticsType:2,year:this.formatDate.year,user:this.platformTime.name};
            ...
            drawLineChart() {
                let $echartsDOM = document.getElementById('chartLine_user2');
    ...
    mounted(){
		let mu = document.getElementById('chartLine_user2');
...
/*<el-form class="user_info" :inline="true" :model="user_info">
    <el-form-item label="搜索用户">
        <el-input v-model="user_info.name" icon="search" size="small"  placeholder="用户名"></el-input>
    </el-form-item>
</el-form>*/