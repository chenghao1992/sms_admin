<template>
	<div class="platform_date">
		...
		<el-row>
            <el-col :span="25">
                <div class="echart" id="chartLine" style="width:100%; height:500px; margin-top:10px"></div>
...
<script>
  ...
  export default {
    ...
    methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                  if (valid) {
                    ...
                    this.mark_total = 0;
                    this.notice_total = 0;
                    let params = {statisticsType:1,year:this.formatDate.year,month:this.formatDate.month};
            ...
            drawLineChart() {
                let $echartsDOM = document.getElementById('chartLine');
    ...
    mounted(){
        ...
        timeObj.month = timeObj.month<10?'0'+timeObj.month:timeObj.month;
        this.txt = timeObj.month+'月';
        let par = {statisticsType:1,year:timeObj.year,month:timeObj.month}
        this.getDatas(par);
    },
    updated: function () {
        /*this.drawCharts()*/
