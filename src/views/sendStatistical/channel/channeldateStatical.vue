<template>
	<div class="channel_date">
		...
		<el-row>
            <el-col :span="25">
                <div class="echart" id="chartLine_channel1" style="width:100%;  height:500px; margin-top:10px"></div>
...
<script>
  ...
  export default {
    ...
    methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                  if (valid) {
                    ...
                    this.wd_total = 0;
                    this.hy_total = 0;
                    let params = {statisticsType:3,year:this.formatDate.year,month:this.formatDate.month};
            ...
            drawLineChart() {
                let $echartsDOM = document.getElementById('chartLine_channel1');
    ...
    mounted(){
        getChannelsLists().then( res=> {
            ...
            let mu = document.getElementById('chartLine_channel1');
            ...
            timeObj.month = myDate.getMonth()+1;
            this.txt = timeObj.month<10?'0'+timeObj.month+'月':timeObj.month+'月';
            let par = {statisticsType:3,year:timeObj.year,month:timeObj.month}
            this.getDatas(par);
        })
        ...
        var id=['123+qqq','456+www','789+zzz'];
        this.getSeries(id,result);*/
    },
    updated: function () {
        /*this.drawCharts()*/
    }
